tellraw @a [{"text": "Finished loading NotBlankDatapack!","color": "#00FF00","bold": true},{"text": " v 1.6.0 ","color": "#505050","bold": false}]
# ,{"text":"r","color":"red"},{"text":"a","color":"gold"},{"text":"i","color":"yellow"},{"text":"n","color":"green"},{"text":"b","color":"aqua"},{"text":"o","color":"blue"},{"text":"w","color":"dark_purple"}
